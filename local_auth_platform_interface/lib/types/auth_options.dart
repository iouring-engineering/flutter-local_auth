...
import 'package:local_auth_platform_interface/types/authenticator.dart';
...
class AuthenticationOptions {
  ...
  /// Used to enable specific types of authenticators during authentication.
  ///
  /// If it is set to [Authenticator.strong] and [Authenticator.weak]
  /// or empty (default), both will be allowed.
  ///
  /// If it is set to [Authenticator.strong],
  /// only strong authenticator ([BiometricType.fingerprint] in Android)
  /// will be allowed
  ///
  /// If it is set to [Authenticator.strong], both [Authenticator.strong] and
  /// [Authenticator.weak] will be allowed
